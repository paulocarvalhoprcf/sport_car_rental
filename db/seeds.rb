...
ferrari_458 = { model: 'Ferrari 458 Italia', manufacturer: 'Ferrari', price: rand(1500..5000), year: '2015', img_url: "https://source.unsplash.com/user/erondu/uPrFF1Qat2s", short_description: "Powered by a 4.5 L - V8  engine generating a power output of 562 hp at 9,000 rpm and 398 lb.ft of torque at 6,000 rpm" }
